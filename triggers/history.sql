...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        PERFORM insert_into_history("target_table", NULL::JSONB, 'INSERT'::DML, to_jsonb(NEW));
        RETURN NEW;
    ELSIF TG_OP = 'UPDATE' THEN
        PERFORM history_update("target_table", TG_RELID, to_jsonb(OLD), to_jsonb(NEW), "columns");
        RETURN NEW;
