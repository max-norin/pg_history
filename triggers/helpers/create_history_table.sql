...
$$
DECLARE
    "history_schema"      CONSTANT REGNAMESPACE NOT NULL  = public.get_history_schema_name("relid")::REGNAMESPACE;
    ...
    "target_table"        CONSTANT TEXT NOT NULL = format('%I.%I', "history_schema", "target_table_name");
BEGIN
